/* =============================================
   PORTALS GAME — Delivery Audit Task
   Phase 1: Send Delivery Files (Offices theme)
   Phase 2: Receive Delivery Files (Storage Bay theme)
   ============================================= */

const DeliveryAuditTask = {
  // Config
  ...
  _onReceiveComplete() {
    ...
    setTimeout(() => {
      ...
      TaskShell.showCompletion('delivery-audit');
    }, 1200);
  },
  ...
  _draw() {
    ...
    // Determine color set
    const isStorage = (this.phase === 'idle-receive' || this.phase === 'receiving' || this.phase === 'complete');
    const colors = isStorage ? this.colors.storage : this.colors.offices;
